...
void MainMenuPage::loop()
{
    ...
    if(hovered == 0) u8g2.drawRFrame(1, y - 11, 61, 16, 5);
    ...
    if(hovered == 2) u8g2.drawRFrame(1, y - 11 + rowSpacing * 2, 47, 16, 5);
